"""
Indicateur i097 : Distance moyenne aux bibliothèques

Source : La Mednum
URL : https://fragilite-numerique.fr/?indicators=library_distance&zoom=6.69&center=1.9687381683510807,48.29670289062969&division_auto=false&division=epci
...
def run(csv_filename: str) -> None:
    ...
    try:
        ensure_indicator_exists(session, "i097") # adapter avec l'indicateur_id
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description= "Import CSV -> valeur_indicateur (indicateur i097)") # "Import CSV -> valeur_indicateur"
    parser.add_argument("--csv", default= "i097.csv", help= "Nom du fichier CSV à importer (dans scripts/source/)",) # adapter le default
